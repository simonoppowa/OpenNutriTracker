...
| **Inclusive** | Non-binary calorie estimation grounded in published trans-health research, ten languages, kcal or kJ, and screen-reader support treated as a bug when it breaks. |
