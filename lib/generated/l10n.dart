...
class S {
  ...
  /// `More Information at\n{sourceName}`
  String additionalInfoLabelSource(Object sourceName) {
    return Intl.message(
      'More Information at\n$sourceName',
      name: 'additionalInfoLabelSource',
      desc: '',
      args: [sourceName],
    );
  }
  ...
  String get carbsLabelShort {
    return Intl.message('c', name: 'carbsLabelShort', desc: '', args: []);
  }
  ...
  String get copyCodeLabel {
    return Intl.message('Copy code', name: 'copyCodeLabel', desc: '', args: []);
  }
  ...
  String deleteSelectedRecipesConfirmTitle(int count) {
    return Intl.message(
      'Delete $count recipe(s)?',
  ...
  String get energyLeftLabel {
    return Intl.message('left', name: 'energyLeftLabel', desc: '', args: []);
  }
  ...
  String get fatLabelShort {
    return Intl.message('f', name: 'fatLabelShort', desc: '', args: []);
  }
  ...
  /// `in`
  String get inLabel {
    return Intl.message('in', name: 'inLabel', desc: '', args: []);
  }
  ...
  String get trendsLabel {
    return Intl.message('Trends', name: 'trendsLabel', desc: '', args: []);
  }
  ...
  String get trendsWaterLabel {
    return Intl.message('Water', name: 'trendsWaterLabel', desc: '', args: []);
  }
  ...
  String importRecipeConfirmContent(int count) {
    return Intl.message(
      'Import this recipe with $count ingredient(s)?',
  ...
  /// `kJ`
  String get kjLabel {
    return Intl.message('kJ', name: 'kjLabel', desc: '', args: []);
  }
  ...
  /// `st`
  String get stLabel {
    return Intl.message('st', name: 'stLabel', desc: '', args: []);
  }
  ...
  String get mealEnergyLabel {
    return Intl.message('Energy', name: 'mealEnergyLabel', desc: '', args: []);
  }
  ...
  String get mealPatternOmad {
    return Intl.message('OMAD', name: 'mealPatternOmad', desc: '', args: []);
  }
  ...
  String get mealSizeLabel {
    return Intl.message('Pack size', name: 'mealSizeLabel', desc: '', args: []);
  }
  ...
  String get paPickleball {
    return Intl.message('pickleball', name: 'paPickleball', desc: '', args: []);
  }

  /// `pilates`
  String get paPilates {
    return Intl.message('pilates', name: 'paPilates', desc: '', args: []);
  }
  ...
  String get paStretching {
    return Intl.message('stretching', name: 'paStretching', desc: '', args: []);
  }
  ...
  String get proteinLabelShort {
    return Intl.message('p', name: 'proteinLabelShort', desc: '', args: []);
  }
  ...
  String get quickAddSubmitLabel {
    return Intl.message('Add', name: 'quickAddSubmitLabel', desc: '', args: []);
  }

  /// `Title`
  String get quickAddTitleHint {
    return Intl.message('Title', name: 'quickAddTitleHint', desc: '', args: []);
  }
  ...
  /// `{count} ingredient(s)`
  String recipeIngredientCountLabel(int count) {
    return Intl.message(
      '$count ingredient(s)',
  ...
  String get recipeTagsLabel {
    return Intl.message('Tags', name: 'recipeTagsLabel', desc: '', args: []);
  }
  ...
  String get transFatLabel {
    return Intl.message('trans fat', name: 'transFatLabel', desc: '', args: []);
  }
  ...
  String get fastingCancel {
    return Intl.message('End fast', name: 'fastingCancel', desc: '', args: []);
  }
  ...
  String get dialogCloseLabel {
    return Intl.message('Close', name: 'dialogCloseLabel', desc: '', args: []);
  }
  ...
  String get profileNameLabel {
    return Intl.message('Name', name: 'profileNameLabel', desc: '', args: []);
  }
  ...
  String get copyActionLabel {
    return Intl.message('Copy', name: 'copyActionLabel', desc: '', args: []);
  }
