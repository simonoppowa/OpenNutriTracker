...
class OFFProductDTO {
  ...
  // OFF carries product names in many languages — these six cover the
  // remaining locales the ONT UI ships in (cs / es / it / sk / tr / uk). When
  // any are missing or blank for a particular product the lookup falls
