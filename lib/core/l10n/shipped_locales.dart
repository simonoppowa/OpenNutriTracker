...
/// for the UI. Food names are a separate, broader list: if Open Food Facts
/// or the food backend carry the language, add it to `SupportedLanguage`
/// (`lib/core/utils/supported_language.dart`) so searches ask for it;
/// otherwise product names stay English, which is not a blocker.
///
/// Keys are bare language codes (`pt`, not `pt_BR`): Weblate is limited to
/// base languages (#1181), and resolution matches on the language code.
/// Region or script variants need code changes first, not just a line here.
///
